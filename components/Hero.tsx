  ...
  return (
    <section className="lg:px-12 lg:pt-16 lg:pb-16 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 min-h-[60vh] lg:min-h-[75vh] max-w-[1600px] mr-auto ml-auto pt-8 pr-6 pb-12 pl-6 items-center">
      <div className="animate-clip-in lg:col-span-7 space-y-6" style={{ animationDelay: '0.1s' }}>
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-medium bg-white/5 border-white/10 text-stone-300">
        ...
        <h1 className="leading-[0.95] lg:text-7xl xl:text-8xl text-5xl font-medium text-white tracking-tighter">
          ...
          <span className="text-[#c1ff72] font-google-sans-flex relative inline-block mx-2">
            Engineered
            <svg className="absolute w-full h-3 -bottom-1 left-0 text-[#c1ff72] -z-10 opacity-20" viewBox="0 0 100 10" preserveAspectRatio="none">
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-2">
          <button className="glass-button all-unset cursor-pointer outline-none focus:outline-none z-30 pointer-events-auto text-base rounded-full relative group">
            <span className="button-text block select-none text-lg font-semibold text-white tracking-tight pt-4 pr-8 pb-4 pl-8 relative">
              Explore Our Products
            </span>
            <div className="button-shine"></div>
          </button>
          <button className="flex items-center justify-center gap-2 px-8 py-4 rounded-full border border-stone-700 font-semibold text-stone-300 hover:bg-white/5 transition-colors">
            See Case Studies
          </button>
        </div>
      </div>
      ...
      <div className="lg:col-span-5 flex flex-col animate-fade-up lg:mt-0 h-full mt-8 relative justify-center" style={{ animationDelay: '0.3s' }}>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-[#c1ff72] opacity-10 blur-[100px] rounded-full pointer-events-none"></div>
        <div className="relative space-y-4">
          ...
          <div className="glass-panel p-4 rounded-xl flex items-center gap-4 animate-float shadow-lg lg:ml-0 max-w-sm mx-auto w-full" style={{ animationDelay: '0s' }}>
            <div className="w-10 h-10 rounded-full flex items-center justify-center border shrink-0 bg-lime-900/30 text-[#c1ff72] border-lime-500/30">
            ...
            <span className="text-[10px] px-2 py-0.5 rounded border font-medium bg-white/5 text-stone-300 border-white/10">98.5% Accuracy</span>
          </div>
          ...
          <div className="glass-panel p-4 rounded-xl flex items-center gap-4 animate-float shadow-lg lg:-ml-4 max-w-sm mx-auto w-full" style={{ animationDelay: '2.5s' }}>
            <div className="w-10 h-10 rounded-full text-[#c1ff72] flex items-center justify-center border shrink-0 bg-stone-800 border-stone-700">
